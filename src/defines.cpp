...
TemplatePosition::TemplatePosition(std::string in_s, glm::vec3 in_v,
                                   float in_rotation, cv::Rect in_boundingBox,
...
ObjectPose::ObjectPose(glm::vec3 tra, glm::quat qua)
    : translation(tra), quaternions(qua) {}

ObjectPose::ObjectPose(glm::vec3 tra, glm::quat qua, cv::Rect bb)
    : translation(tra), quaternions(qua), boundingBox(std::move(bb)) {}
